...
# -*- coding: utf-8 -*-
#
# ActiveHTMLWidget documentation build configuration file
#
...
project = 'ActiveHTMLWidget'
copyright = '2022, b3m2a1'
author = 'b3m2a1'
...
_version_py = os.path.join(repo, 'ActiveHTMLWidget', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'ActiveHTMLWidgetdoc'
...
latex_documents = [
    (master_doc, 'ActiveHTMLWidget.tex', 'ActiveHTMLWidget Documentation',
     'b3m2a1', 'manual'),
]
...
man_pages = [
    (master_doc,
    'ActiveHTMLWidget',
    'ActiveHTMLWidget Documentation',
     [author], 1)
]
